export const privacyPoints = [
  {
    ...
    items: [
      ...
      "Technical assessment scores: LeetCode, HackerRank, and similar technical assessment scores and performance data.",
    ],
  },
  {
    title: "2. Use of Personal Information:",
    description:
      "We use the collected personal information for various purposes, including but not limited to:",
    items: [
      "Providing and improving our services to you",
      "Responding to your inquiries and requests",
      "Sending you relevant updates and notifications",
      "Analyzing and enhancing the effectiveness of our services",
  ...
  },
  {
    ...
    items: [
      ...
      "In connection with a merger, acquisition, or sale of assets, where your data may be transferred as part of the transaction",
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      "Withdrawal of Consent: You can withdraw your consent for processing your data at any time.",
    ],
  },
  {
